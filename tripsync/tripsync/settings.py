...
SECRET_KEY = "django-insecure-rqj!i#qij8h)-e8t7kafk%o90(agcpdt08ww2&g_=gw-*vh58n"
...
MIDDLEWARE = [
    ...
    "apps.users.user_activity_logger.UserActivityLoggerMiddleware",
]
...
TEMPLATES = [
    ...
    },
    {
        ...
        "DIRS": [
            BASE_DIR / "templates",  # path where Jinja2 templates are stored
        ],
        "APP_DIRS": True,
    },
]
